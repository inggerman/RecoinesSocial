...
Amigos.create({id2:'1',name:'German',apellidoPaterno:'Hernandez',apellidoMaterno:'Lopez',username:'ghl',iduser:2}).exec(console.log);
Amigos.create({id2:'2',name:'Gustavo',apellidoPaterno:'Hernandez',apellidoMaterno:'Lopez',username:'ghl13',iduser:3}).exec(console.log);
Amigos.create({id2:'3',name:'Pascual',apellidoPaterno:'Hernandez',apellidoMaterno:'Dominguez',username:'phd',iduser:1}).exec(console.log);
Amigos.create({id2:'4',name:'Rocio',apellidoPaterno:'Lopez',apellidoMaterno:'Degante',username:'rld',iduser:1}).exec(console.log);
Amigos.create({id2:'5',name:'Carolina',apellidoPaterno:'Degante',apellidoMaterno:'Lopez',username:'cdl',iduser:1}).exec(console.log);
Amigos.create({id2:'6',name:'Maria Luisa',apellidoPaterno:'Xochihua',apellidoMaterno:'Mendieta',username:'mlxm',iduser:1}).exec(console.log);
Amigos.create({id2:'7',name:'Pedro',apellidoPaterno:'Briones',apellidoMaterno:'Lopez',username:'lbp',iduser:1}).exec(console.log);
Amigos.create({id2:'8',name:'Anacleto',apellidoPaterno:'smith',apellidoMaterno:'Mendez',username:'asl',iduser:1}).exec(console.log);
Amigos.create({id2:'9',name:'Aurelio',apellidoPaterno:'casillas',apellidoMaterno:'Lopez',username:'acl',iduser:1}).exec(console.log);

Roompost.create({nombre:'ghl'}).exec(console.log);
Roompost.create({nombre:'ghl13'}).exec(console.log);
Roompost.create({nombre:'phd'}).exec(console.log);
Roompost.create({nombre:'rld'}).exec(console.log);
