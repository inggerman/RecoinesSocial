...
Users.create({ncontrol:'10370710',password:'perro',nombre:'german',apellido_p:'hdz',apellido_m:'lpz',correo_inst:'pato1@cc.com'}).exec(console.log);
Users.create({ncontrol:'10370711',password:'perro',nombre:'fgfdg',apellido_p:'hdz',apellido_m:'lpz',correo_inst:'pato2@cc.com'}).exec(console.log);
Users.create({ncontrol:'10370712',password:'perro',nombre:'marlux',apellido_p:'hdz',apellido_m:'lpz',correo_inst:'pato3@cc.com'}).exec(console.log);
